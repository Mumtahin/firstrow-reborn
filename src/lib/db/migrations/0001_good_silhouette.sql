...
--> statement-breakpoint
ALTER TABLE "user" RENAME COLUMN "profile_picture" TO "image";--> statement-breakpoint
ALTER TABLE "user" DROP CONSTRAINT "user_google_id_unique";--> statement-breakpoint
ALTER TABLE "favourite" DROP CONSTRAINT "favourite_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "favourite" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
